...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Fabian\Desktop\My python projects\Lexical Analyzer'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Fabian\Desktop\My python projects\Lexical Analyzer\Scripts\deactivate.nu'
